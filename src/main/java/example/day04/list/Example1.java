    ...
    public static void main(String[] args) {
        ...
        // 1. List
            ...
            // 제공하는 함수
                ...
                //2. 리스트객체명.add(인덱스,객체)   : 주어진 객체를 리스트내 주어진 인덱스에 추가[추가 인덱스
                //3. 리스트객체명.set(인덱스, 객체)  : 주어진 객체를 리스트내 주어진 인덱스번호에 넣음
                //4. 리스트객체명.size()           : 리스트내 저장된 객체 수를 반환
                //5. 리스트객체명.get(인덱스)       : 주어진 인덱스에 저장된 객체를 반환
                //6. 리스트객체명.contains(객체)    : 주어진 객체가 리스트내 저장되어 있는지
                //7. 리스트객체명.remove(인덱스)    : 주여진 인덱스에 저장된 객체를 삭제
